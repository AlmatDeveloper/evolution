...
// java приложение работает пока есть хотя бы один поток(не демон)
// потоки могут быть обычными, а так же демонами
// в качестве примера:
// демон поток можно использовать когда нам не жалко остановить данный поток
public class DemonExampleClass {
    public static void main(String[] args) {
        ...
        // потоки-демоны работают до тех пор,
        // пока работает хотя бы один поток в приложении(не демон)
        thread.setDaemon(true);
        // получить статус потока
        // не имеет смысла отталкиваться от статуса так как он может быстро меняться
