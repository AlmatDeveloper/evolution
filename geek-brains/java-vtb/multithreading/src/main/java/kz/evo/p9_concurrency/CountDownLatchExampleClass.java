...
// и main поток должен дождаться остановки всех потоков
// (join прописать не получится так как нет ссылок)
...
public class CountDownLatchExampleClass {
    public static void main(String[] args) {
        ...
        // countDownLatch одноразовый, это означает что при обнулении,
        // не будет возможности вернуться на значение параметра
