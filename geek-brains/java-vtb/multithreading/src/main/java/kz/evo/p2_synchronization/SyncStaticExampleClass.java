...
// если synchronized повешан на статический метод,
// то монитором будет служить сам класс в котором есть этот метод
// классы так же подгружаются как и объекты в память,
// из-за этого класс можно использовать как объект
public class SyncStaticExampleClass {
    public static void main(String[] args) {
        // если запустить статический и нестатический синхронизированные методы,
    ...
    // если поток вызвал данный метод,
    // никакой другой поток не может вызывать статический синхронизированный метод в классе
